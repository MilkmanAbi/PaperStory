...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var wall = el('div','wall'); wall.style.backgroundImage='url('+W+'w-night-forest.jpg)'; wall.style.opacity=1;
    var scrim = el('div'); scrim.id='scrim';
    scrim.style.background='linear-gradient(180deg, rgba(12,14,24,0.34), rgba(9,9,18,0.58))';
    ...
    document.body.append(wall,scrim,wxCanvas,canvas);
    // a light, cozy snow over the cover
    if (window.Weather){ Weather.init(wxCanvas); Weather.use('snow'); Weather.setIntensity(0.5); }
